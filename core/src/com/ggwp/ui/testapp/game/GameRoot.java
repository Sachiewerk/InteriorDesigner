package com.ggwp.ui.testapp.game;
...
import com.ggwp.ui.testapp.GameScreen;
		...
		this.addListener(new EventListener() {
			...
			public boolean handle(Event event) {
				if (event instanceof MobRemoveEvent) {
					...
					if (event instanceof MobRemoveEvent.MobTouchedEvent) {
						stats.pointUp();
						screen.pointsChanged(stats.getPoints());
					} else if (event instanceof MobRemoveEvent.MobExplodeEvent) {

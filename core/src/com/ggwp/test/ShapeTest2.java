 ...
 */
public class ShapeTest2 extends InputAdapter implements ApplicationListener {
    ...
    private void doneLoading () {
        ...
        for (int i = 0; i < model.nodes.size; i++) {
            ...
            if (id.startsWith("ship")) {
                Model sofa = assets.get("sofa.obj", Model.class);
                instance = new GameObject(assets.get("sofa.obj", Model.class));
            }else{
                instance = new GameObject(model, id, true);
            }

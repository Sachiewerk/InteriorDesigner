...
//        categories.addActor(createCategoryContainer("Aircon", "furnitures/categories/aircon.png", defaultTextButtonStyle, airconClickListener));
    ...
    private Container createFramesContainer(){
        ...
        main.row();
        main.add(createFurnitureCard("Cyndi @ 7.421x3.425", "furnitures/frames/4/4.jpg", createListener("furnitures/frames/4/4.obj", GameObject.TYPE_WALL_OBJECT)));
        main.add(createFurnitureCard("Cyndi 2 @ 7.421x3.425\"", "furnitures/frames/5/5.jpg", createListener("furnitures/frames/5/5.obj", GameObject.TYPE_WALL_OBJECT)));
    ...
    private Container createWashingMachineContainer(){
        ...
        main.add(createFurnitureCard("LG WD-80302NUP @ 4.067x5.754x3.172", "furnitures/washingmachine/1/1.jpg", createListener("furnitures/washingmachine/1/model.g3db", GameObject.TYPE_FLOOR_OBJECT)));
    ...
    private Container createAirconContainer(){
        ...
        main.defaults().left().pad(20f).padRight(0);
        main.columnDefaults(2).padRight(20f);
        main.add(new Label("Aircons", SkinManager.getDefaultCatalogHeaderLabelStyle())).colspan(3);
        main.row();
    ...
    private Container createElectricFanContainer(){
        ...
        main.add(createFurnitureCard("Wall fan 21 @ 3.337x6.261x2.2801\"", "furnitures/electricfan/1/1.jpg", createListener("furnitures/electricfan/1/model.g3db", GameObject.TYPE_WALL_OBJECT)));
    ...
    private Container createBookShelfContainer(){
        ...
        main.defaults().left().pad(20f).padRight(0);
        main.columnDefaults(2).padRight(20f);
        main.add(new Label("Book Shelves", SkinManager.getDefaultCatalogHeaderLabelStyle())).colspan(3);
        main.row();
    ...
    private Container createDiningContainer(){
        ...
        main.defaults().left().pad(20f).padRight(0);
        main.columnDefaults(2).padRight(20f);
        main.add(new Label("Dining Sets", SkinManager.getDefaultCatalogHeaderLabelStyle())).colspan(3);
        main.row();
    ...
    private Container createKitchenContainer(){
        ...
        main.defaults().left().pad(20f).padRight(0);
        main.columnDefaults(2).padRight(20f);
        main.add(new Label("Kitchens", SkinManager.getDefaultCatalogHeaderLabelStyle())).colspan(3);
        main.row();
